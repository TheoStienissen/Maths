...
elsif p_matrix(1).count = 3 and p_matrix.count = 3 then return 
...
then
  raise_application_error(-20004, 'Crossproductonly defined for dimension 3. Dimension vector 1 ' || p_vector1.count || '. Dimension vector 2: '|| p_vector2.count || '.');
end if;
