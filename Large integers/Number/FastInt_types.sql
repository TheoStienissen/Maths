...
-- @"C:\Users\Theo\OneDrive\Theo\Project\Maths\Large integers\Number\FastInt_types.sql"
...
select * from certificate_tests where cert_id = 248 order by lowerbound;
...
begin
fast_int.p_check_certificate (100);
end
/

begin
  fast_int.run_certificate_test (100, 400);
end;
/
