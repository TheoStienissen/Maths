...
-- Load the initial value
    ...
    then
      ...
      l_init_val := fast_int_pkg.save_number (l_first_b2);
      update fast_int_cert_join set init_val = l_init_val where fast_int_id = p_integer_id;
	else l_first_b2  := fast_int_pkg.load_number (l_init_val);
    end if;
	commit;
...
-- Save initial value for  A ** 2 - N 
  ...
  dbms_output.put_line ('Initial upperbound: ' || l_lower_start);
...
begin
  fast_int_pkg.run_factoring_routine (188, 40, 100);
end;
/
