...
Link:   @C:\Users\Theo\OneDrive\Theo\Project\Maths\Matrix\Matrix_Q_C_pkg.sql
-- N x M Matrix:
-- ( 11   ...    1m )
--        ...
-- ( n1   ...    nm )
...
--drop table matrix_Q_C;
create table matrix_Q_C
( id          number (6)  not null
, name        varchar2 (20)
, n           number (10) not null
, m           number (10) not null
, re_numerator   number (38) not null
, im_numerator   number (38) not null
, re_denominator number (38) not null
, im_denominator number (38) not null);

create or replace trigger matrix_Q_C_briu
before insert or update on matrix_Q_C
for each row
declare
l_gcd    integer;
begin
...
alter table matrix_Q add constraint matrix_Q_ck1 check (re_denominator != 0 or im_denominator != 0);
