...
as
type point_Q_ty    is record (val_numerator number(36), val_denominator number(36));
type vector_Q_ty   is table of point_Q_ty  index by pls_integer;
type matrix_Q_ty   is table of vector_Q_ty index by pls_integer;
type point_Q_ty_2D is record (x_c point_Q_ty, y_c point_Q_ty);
type point_Q_ty_3D is record (x_c point_Q_ty, y_c point_Q_ty, z_c point_Q_ty);

procedure init_matrix (p_matrix in out nocopy matrix_Q_ty, p_horizontal_size in number default 3, p_vertical_size in number default 3);

function  to_point_Q_2D (p_x in point_Q_ty, p_y in point_Q_ty) return point_Q_ty_2D;

function  to_point_Q_3D (p_x in point_Q_ty, p_y in point_Q_ty, p_z in point_Q_ty) return point_Q_ty_3D;

function  to_vector (p_x1  in point_Q_ty, p_x2 in point_Q_ty default null, p_x3 in point_Q_ty default null, p_x4 in point_Q_ty default null,
                     p_x5  in point_Q_ty default null, p_x6  in point_Q_ty default null, p_x7  in point_Q_ty default null,
					 p_x8  in point_Q_ty default null, p_x9  in point_Q_ty default null, p_x10 in point_Q_ty default null,
					 p_x11 in point_Q_ty default null, p_x12 in point_Q_ty default null, p_x13 in point_Q_ty default null,
					 p_x14 in point_Q_ty default null, p_x15 in point_Q_ty default null, p_x16 in point_Q_ty default null) return vector_Q_ty;

function  to_matrix_Q_2D (p_x11 in point_Q_ty, p_x12 in point_Q_ty, p_x21 in point_Q_ty, p_x22 in point_Q_ty) return matrix_Q_ty;
 
function  to_matrix_Q_3D (p_x11 in point_Q_ty, p_x12 in point_Q_ty, p_x13 in point_Q_ty, p_x21 in point_Q_ty, p_x22 in point_Q_ty,
                        p_x23 in point_Q_ty, p_x31 in point_Q_ty, p_x32 in point_Q_ty, p_x33 in point_Q_ty) return matrix_Q_ty;
...
is
begin
  return point_Q_ty_3D (p_x, p_y, p_z);
