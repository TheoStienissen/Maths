...
type line_ty          is table of  number(8, 4) index by pls_integer;
type matrix_ty        is table of line_ty index by pls_integer;
type point_ty_2D      is record (x_c number(8, 4), y_c number(8, 4));
type point_ty_3D      is record (x_c number(8, 4), y_c number(8, 4), z_c number(8, 4));
